(function () {
	...
	.directive("publicLibraryPage", Directive);
	
	function Directive(){
		 return {
	    	restrict: 'E',
	    	templateUrl: 'angular/pages/public-library/public-library-page.directive.html',
	...
	function DirectiveController($stateParams, rest, pages, $translate, config, alerts){
		...
		function refreshCollectionsList(pageSize, pageNumber, useCache, forceReload){
			...
			return rest.collection.getPublic(pageSize, pageNumber, useCache, forceReload).then(function(data){
				if(data.Result != null){
